...
#define LCD_A0                                               D7                                                                                               // set by application
#define MBED_CONF_APP_ESP8266_SSID                           "SSID"                                                                                           // set by application
...
#define MBED_CONF_APP_ESP8266_DEBUG                          1                                                                                                // set by application
#define LCD_MISO                                             D12                                                                                              // set by application
#define MBED_CONF_APP_ESP8266_TX                             D1                                                                                               // set by application
...
#define MBED_CONF_APP_ESP8266_PASSWORD                       "Password"                                                                                       // set by application
...
#define LCD_NCS                                              D10                                                                                              // set by application
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_SECURITY_MODE     NONE                                                                                             // set by library:mbed-mesh-api
#define MBED_CONF_APP_ESP8266_RX                             D0                                                                                               // set by application
